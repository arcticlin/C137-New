...
class ApiRedis(RedisCli):
    ...
    def get_env_temp_rk(self, env_id: int):
        return f"api:{self.trace_id}:e:e_{env_id}_temp"

    def get_case_rk(self, case_id: Union[str, int]):
    ...
    async def init_case_key(self, case_id: Union[str, int]):
        """初始化case key"""
